...
public class JsonPersistenceImplementor<T> implements PersistenceImplementor<T> {
    ...
    public void saveAll(List<T> list) {
        try {
            ...
            logger.log(Level.SEVERE, "Erro ao salvar JSON: " + dataFilePath, e);
        }
    }
    ...
    public boolean checkOrCreateFile() {
        ...
        try {
            ...
            logger.log(Level.SEVERE, "Erro ao verificar/criar arquivos JSON", e);
        }
        return exists;
    }
    ...
    private void saveLastId() {
        try {
            ...
            try (BufferedWriter writer = new BufferedWriter(new FileWriter(idFilePath))) {
                writer.write(Long.toString(lastId.get()));
            }
        } catch (IOException e) {
            logger.log(Level.SEVERE, "Erro ao salvar ID: " + idFilePath, e);
        }
    }
}
